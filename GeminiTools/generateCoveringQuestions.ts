...
export async function GenerateConveringQuestions({
  ...
  const prompt =
    ...
    "* The `question_text`, `student_answer`, and `correct_answer` fields in this input is in its original language.\n" +
    "```json\n" +
    "```json\n" +
    ...
    "* This score reflects overall understanding of the syllabus concepts, irrespective of the language of the syllabus or past questions.\n" +
    "* A student who has answered many questions incorrectly across various topics should have a lower score.\n" +
    ...
    `"question": "[Generated question text in an ${language}]",\n` +
    ...
    "\n\nSyllabus: " +
    "\n\nSyllabus: " +
    JSON.stringify(syllabus) + // Assuming syllabus is defined in your scope
